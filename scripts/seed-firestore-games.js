...
const PLANET_PAIRS = [
  ...
  ['Venus', 'planeta muy caliente'],
  ['Tierra', 'nuestro planeta'],
  ['Marte', 'planeta rojo'],
  ['Júpiter', 'planeta más grande'],
  ['Saturno', 'planeta con anillos'],
  ['Urano', 'planeta inclinado'],
  ['Neptuno', 'planeta azul lejano'],
  ['Plutón', 'planeta enano famoso'],
  ['Ceres', 'objeto del cinturón de asteroides'],
  ['Cometa', 'cuerpo con cola brillante'],
  ['Asteroide', 'roca que gira alrededor del Sol'],
  ['Meteorito', 'roca que cae a la Tierra'],
  ['Órbita', 'camino de un planeta'],
  ['Galaxia', 'gran grupo de estrellas'],
  ['Vía Láctea', 'galaxia en la que vivimos'],
  ['Constelación', 'grupo de estrellas con forma'],
  ['Telescopio', 'instrumento para mirar el cielo'],
  ['Astronauta', 'persona que viaja al espacio'],
  ['Cohete', 'vehículo para salir de la Tierra'],
  ['Satélite', 'objeto que gira alrededor de un planeta'],
  ['Eclipse', 'cuando un astro tapa a otro'],
  ['Gravedad', 'fuerza que nos mantiene en el suelo'],
  ['Cráter', 'hueco en la superficie lunar'],
  ['Estrella fugaz', 'luz rápida en el cielo'],
  ['Sistema solar', 'familia del Sol y sus planetas'],
  ['Planeta enano', 'astro más pequeño que un planeta'],
  ['Anillo', 'banda que rodea a Saturno'],
  ['Rotación', 'giro de un astro sobre sí mismo'],
  ['Traslación', 'vuelta alrededor del Sol'],
  ['Día', 'tiempo que tarda la Tierra en girar'],
  ['Año', 'tiempo que tarda la Tierra en dar una vuelta al Sol'],
  ['Luna llena', 'fase con la Luna redonda'],
  ['Luna nueva', 'fase en la que casi no se ve'],
  ['Cuarto creciente', 'media Luna que crece'],
  ['Cuarto menguante', 'media Luna que disminuye'],
  ['Aurora boreal', 'luces de colores en el cielo'],
  ['Marciano', 'habitante imaginario de Marte'],
  ['Sonda espacial', 'robot que explora el espacio'],
  ['Estación espacial', 'laboratorio que orbita la Tierra'],
  ['Nebulosa', 'nube de gas y polvo'],
  ['Agujero negro', 'zona con gravedad enorme'],
  ['Universo', 'todo lo que existe'],
  ['Observatorio', 'lugar para estudiar el cielo'],
  ['Cosmonauta', 'astronauta ruso'],
  ['Despegue', 'inicio de un vuelo espacial'],
  ['Aterrizaje', 'llegada de una nave al suelo'],
  ['Cápsula espacial', 'cabina de una misión'],
  ['Módulo lunar', 'vehículo para bajar a la Luna'],
  ['Traje espacial', 'ropa para salir al espacio'],
  ['Antena', 'pieza que envía señales'],
  ['Radar', 'sistema para detectar objetos'],
  ['GPS', 'sistema de satélites para ubicarse'],
  ['Mar de la Tranquilidad', 'zona famosa de la Luna'],
  ['Cara oculta', 'lado de la Luna que no vemos'],
  ['Polo norte', 'extremo superior de un planeta'],
  ['Ecuador', 'línea central de un planeta'],
  ['Atmósfera', 'capa de gases de un planeta'],
  ['Nube', 'masa de vapor en el cielo'],
  ['Tormenta solar', 'explosión de energía del Sol'],
  ['Mancha solar', 'zona oscura del Sol'],
  ['Amanecer', 'salida del Sol'],
  ['Atardecer', 'puesta del Sol'],
  ['Equinoccio', 'día con igual luz y noche'],
  ['Solsticio', 'día más largo o más corto del año'],
  ['Hemisferio', 'mitad de un planeta'],
  ['Globo terráqueo', 'modelo de la Tierra'],
  ['Mapa estelar', 'dibujo del cielo nocturno'],
  ['Lanzadera', 'vehículo para lanzar naves'],
  ['Cuenta atrás', 'números antes del despegue'],
  ['Misión espacial', 'viaje preparado al espacio'],
  ['Exploración', 'búsqueda de nuevos lugares'],
  ['Alienígena', 'ser imaginario de otro planeta'],
  ['Rover', 'vehículo que recorre otro mundo'],
  ['Perseverance', 'rover que explora Marte'],
  ['Apollo 11', 'misión que llegó a la Luna'],
  ['Saturno V', 'cohete gigante de la NASA'],
  ['NASA', 'agencia espacial de Estados Unidos'],
  ['ESA', 'agencia espacial europea'],
  ['Hubble', 'telescopio espacial famoso'],
  ['James Webb', 'telescopio espacial moderno'],
  ['Estrella polar', 'estrella que marca el norte'],
  ['Osa Mayor', 'constelación muy conocida'],
  ['Orión', 'constelación del cazador'],
  ['Lluvia de estrellas', 'muchos destellos en el cielo'],
  ['Vacío', 'espacio casi sin aire'],
  ['Marea', 'subida y bajada del mar'],
  ['Fase lunar', 'aspecto visible de la Luna'],
  ['Astronomía', 'ciencia que estudia el espacio'],
  ['Planetario', 'lugar para aprender sobre el cielo'],
  ['Exoplaneta', 'planeta que no gira alrededor del Sol'],
  ['Luz solar', 'claridad que viene del Sol'],
  ['Brújula', 'instrumento para orientarse'],
  ['Horizonte', 'línea donde parece unirse cielo y tierra'],
  ['Invierno', 'estación más fría del año'],
  ['Verano', 'estación más calurosa del año'],
  ['Primavera', 'estación de las flores'],
  ['Otoño', 'estación de las hojas secas']
];
const SHADOW_PAIRS = [
